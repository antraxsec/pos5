...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    handleReceivedAmountKeyup: function handleReceivedAmountKeyup(receivedAmount) {
    ...
    Create_Client: function Create_Client() {
      ...
      axios.post("clients", {
        ...
        nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
        _this17.makeToast("success", _this17.$t("Create.TitleCustomer"), _this17.$t("Success"));
        _this17.Get_Client_Without_Paginate(true);
        _this17.$bvModal.hide("New_Customer");
      })["catch"](function (error) {
    ...
    Get_Client_Without_Paginate: function Get_Client_Without_Paginate() {
      var _this18 = this;
      var selectLast = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
      axios.get("get_clients_without_paginate").then(function (_ref4) {
        var data = _ref4.data;
        _this18.clients = data;
        if (selectLast && _this18.clients.length > 0) {
          _this18.sale.client_id = _this18.clients[_this18.clients.length - 1].id;
        }
      });
    }
  },
...
var render = function render() {
  ...
  return _c("div", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref) {
        ...
        })])], 1)], 1), _vm._v(" "), _c("b-form-invalid-feedback", [_vm._v(_vm._s(errors[0]))])], 1);
      }
    }], null, false, 44057115)
  })], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-3",
    ...
    return _c("tr", [_c("td", [_vm._v(_vm._s(detail.detail_id))]), _vm._v(" "), _c("td", [_c("span", [_vm._v(_vm._s(detail.name))]), _vm._v(" "), _c("br"), _vm._v(" "), _c("span", {
      staticClass: "badge badge-dark"
    }, [_vm._v(_vm._s(detail.code))])]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(detail.Net_price, 3)))]), _vm._v(" "), _c("td", [detail.product_type == "is_service" ? _c("span", {
      staticClass: "badge badge-outline-dark"
    }, [_vm._v("----")]) : _c("span", {
      staticClass: "badge badge-outline-dark"
    ...
    }, [_vm._v("+")])])], 1)], 1)]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(detail.subtotal.toFixed(2)))]), _vm._v(" "), _c("td", [_vm.currentUserPermissions && _vm.currentUserPermissions.includes("edit_product_sale") ? _c("i", {
    ...
    staticClass: "bold"
  }, [_vm._v(_vm._s(_vm.$t("OrderTax")))]), _vm._v(" "), _c("td", [_c("span", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.sale.TaxNet.toFixed(2)) + " (" + _vm._s(_vm.formatNumber(_vm.sale.tax_rate, 2)) + "\n                            %)")])])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "bold"
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(validationContext) {
        return [_c("b-form-group", {
          ...
          on: {
            keyup: function keyup($event) {
              return _vm.handleReceivedAmountKeyup(_vm.payment.received_amount);
            }
          },
          model: {
  ...
  }, [_vm._v(_vm._s(_vm.$t("Change")) + " :")]), _vm._v(" "), _c("p", {
  ...
  }, [_vm._v("\n                    " + _vm._s(parseFloat(_vm.payment.received_amount - _vm.payment.amount).toFixed(2)))])]) : _vm._e(), _vm._v(" "), _vm.payment.status != "pending" && _vm.payment.Reglement == "credit card" && _vm.sale.statut == "completed" ? _c("b-col", {
    staticClass: "mt-3",
    attrs: {
      md: "12"
    }
    ...
    staticClass: "i-Yes me-2 font-weight-bold"
  }), _vm._v(" " + _vm._s(_vm.$t("submit")) + "\n                ")]), _vm._v(" "), _vm.Submit_Processing_detail ? _vm._m(2) : _vm._e()], 1)], 1)], 1)], 1)], 1)], 1), _vm._v(" "), _c("validation-observer", {
    ref: "Create_Customer"
  }, [_c("b-modal", {
    attrs: {
      "hide-footer": "",
