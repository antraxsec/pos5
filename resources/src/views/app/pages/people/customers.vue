      ...
      <b-modal hide-footer size="lg" id="New_Customer" :title="editmode?$t('Edit'):$t('Add')">
        <b-form @submit.prevent="Submit_Customer">
          <b-row>
             ...
             <!-- Customer Tax Number -->
            <b-col md="6" sm="12">
                <b-form-group :label="$t('Tax_Number')" class="font-weight-bold">
                  <b-form-input
                    label="Tax Number"
            ...
            <b-col md="6" sm="12">
              <validation-provider
                ...
                v-slot="validationContext"
              >
                <b-form-group :label="$t('CustomerName') + ' ' + '*'" class="font-weight-bold">
                  <b-form-input
                    :state="getValidationState(validationContext)"
            ...
            <!-- Customer Phone -->
            <b-col md="6" sm="12">
                <b-form-group :label="$t('Phone')" class="font-weight-bold">
                  <b-form-input
                    label="Phone"
  ...
  methods: {
    ...
    clients_PDF() {
      ...
      let columns = [
        ...
        { title: "Cédula de identidad", dataKey: "tax_number" },
        { title: "Nombre", dataKey: "name" },
        { title: "Deuda de Venta", dataKey: "due" },
        { title: "Deuda de Devolución de Venta", dataKey: "return_Due" },
